...
export default function TaskflowPublicPage() {
  ...
  // Datos del negocio
  const [businessName, setBusinessName] = useState("TaskFlow");
  ...
  useEffect(() => {
    async function loadBusiness() {
      try {
        ...
        // const res = await fetch(`/api/public/taskflow/${slug}`);
  ...
  const handleSubmit = async () => {
    try {
      ...
      // await fetch(`/api/public/taskflow/book`, {
      //   method: 'POST',
      //   body: JSON.stringify({ ... })
      // });
